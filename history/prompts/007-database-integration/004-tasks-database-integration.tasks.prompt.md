...
user: anonymous
command: sp.tasks
labels: [tasks, agent, mcp, chatkit, cohere, voice, security]
links:
...
files:
  ...
  - specs/007-database-integration/contracts/mcp-tools.json
...
Generated comprehensive task breakdown for Database Integration feature with 27 detailed tasks across 6 phases:
...
Key breakdown:
- 27 total tasks from T001 to T027
...
- 📁 Files: Created tasks.md with 27 actionable tasks, security tests, documentation.
