    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-blue-900 via-purple-900 to-gray-900 text-white p-12 flex-col justify-center">
        <div className="max-w-md">
          <h1 className="text-4xl font-bold mb-6">Welcome Back to TASKAPP</h1>
          <p className="text-xl text-gray-200 mb-8">
            Streamline your tasks, amplify your productivity. Join thousands of users who have transformed their workflow.
          </p>
